...
import RobinhoodLogo from "../public/robinhood.png";
...
const Jobs = () => {
  const [selected, setSelected] = useState("Robinhood Markets");
  const experience = [
    {
      company: "Robinhood Markets",
      image: RobinhoodLogo,
      titles: ["Backend Software Engineer Intern"],
      borderColor: "before:bg-green-500",
    },
    {
      company: "Zaya Health",
      image: ZayaLogo,
      titles: ["Fullstack Software Engineer Intern"],
